...
CREATE TABLE `orderservices` (
  ...
  KEY `fk_orderservices_servicetypeid_idx` (`servicetypeid`),
  CONSTRAINT `fk_orderservices_orderid` FOREIGN KEY (`orderid`) REFERENCES `orders` (`orderid`),
  CONSTRAINT `fk_orderservices_servicetypeid` FOREIGN KEY (`servicetypeid`) REFERENCES `servicetypes` (`servicetypeid`)
...
-- Dump completed on 2019-09-09  0:42:58
